...
{
    $sql = "INSERT INTO users (email, address, gender,phone , fullname, dob, city, state ,pin, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    if($stmt)
    {
        mysqli_stmt_bind_param($stmt, "ssssssssss" ,$email ,$address, $gender, $phone, $fullname ,$age ,$city ,$state ,$pin, $param_password);//to create two new parameter to store string
