...
if (isset($_POST["update"])) {//when the update button is clicked
    ...
    $pin = mysqli_real_escape_string($conn, $_POST["pin"]);
            ...
            $sql = "UPDATE users SET fullname='$fullname', phone='$phone', dob='$dob',address='$address',city='$city',state='$state',pin='$pin'  WHERE email='{$_SESSION["email"]}'";
   ...
   <body>
       <center>
           ...
           <form action="" method="POST">
               ...
               <input type="text" name="address" placeholder="Enter the address" required><br>
               <input type="text" name="city" placeholder="Enter the city" required><br>
               <input type="text" name="state" placeholder="Enter the state" required><br>
               <input type="text" name="pin" placeholder="Enter the pin code" required><br>
