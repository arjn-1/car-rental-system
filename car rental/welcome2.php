                    ...
                    <div class="questions__group">
                        <div class="questions__item">
                            <header class="questions__header">
                                ...
                                <h3 class="questions__item-title">
                                  <A href = "viewpostadmin.php"> VIEW RENTAL CARS</A>
                                </h3>
                            </header>
                        ...
                        <div class="questions__item">
                            <header class="questions__header">
                                ...
                                <A href = "addpost_user_sell.php"> SELL YOUR CARS</A>
                                </h3>
                            </header>
                    ...
                    <div class="questions__group">
                        <div class="questions__item">
                            <header class="questions__header">
                                <i class="ri-add-line questions__icon"></i>
                                <h3 class="questions__item-title">
                                <A href = "userdetails.php"> VIEW YOUR DETAILS</A>
                                </h3>
                            </header>
                        ...
                        <div class="questions__item">
                            <header class="questions__header">
                                <i class="ri-add-line questions__icon"></i>
                                <h3 class="questions__item-title">
                                <A href = "updateuserdetails.php"> UPDATE YOUR DETAILS</A>
                                </h3>
                            </header>
